...
SKP1LD    EQU  $86            OP CODE OF LDA #  - SKIP THE NEXT BYTE AND
*                             LOAD THE VALUE OF THAT BYTE INTO ACCA - USUALLY
*                             USED TO LOAD ACCA WITH A NON-ZERO VALUE
...
* THE FOLLOWING BYTES ARE INITIALISED FROM ROM AT LA10D
LPTCFW    RMB  1              16
LPTLCF    RMB  1              112
LPTWID    RMB  1              132
LPTPOS    RMB  1              0
...
* LINE INPUT ROUTINE IS COPIED TO HERE FROM ROM
GETNCH    RMB  2
          RMB  2
          RMB  2
GETCCH    RMB  1              *PV OP CODE OF LDA EXTENDED
CHARAD    RMB  2              *PV ADDR OF CHAR BEING PROCESSED
          RMB  3              *PV JUMP BACK INTO THE BASIC RUM
...
BFRQSV
          RTI
*
* THESE BYTES AND THE LINE INPUT ROUTINE ARE MOVED TO
* ADDRESSES $76-$87 (18 BYTES)
...
* LINE INPUT ROUTINE PICKS UP THE NEXT INPUT CHARACTER FROM
...
* INTERPRETED IS STORED AT CHARAD.
          ...
          BNE  LA123          *PV BRANCH IF NOT ZERO (NO CARRY)
          INC  CHARAD         *PV INCREMENT MS BYTE OF INPUT POINTER
LA123     LDA  >0000          *PV THE 0000 WILL CONTAIN THE ADDRESS OF
*                             *PV THE CURRENT CHARACTER THAT THE BASIC
*                             *PV INTERPRETER IS PROCESSING
          JMP  BROMHK         *PV JUMP BACK INTO THE BASIC ROM

* THESE BYTES ARE MOVED TO ADDRESSES $A7-$B4 (NAC: ACTUALLY THEY ARE NOT..)
...
* DO SECONDARIES (LEFT$, RIGHT$, MID$)
          ...
          FCB  $8E            OP CODE OF LDX# - SKIP 2 BYTES
